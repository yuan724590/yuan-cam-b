...
import yuan.cam.bb.mapper.ComputerConfigMapper;
...
public class SourceServiceImpl implements SourceService {
    ...
    @Override
    public List<ConfigVO> queryConfig(Map<String, String> search, Integer page, Integer size, String qid) {
        ...
        return configList.stream().map(element ->{
            ...
            configVO.setName(element.getName());
